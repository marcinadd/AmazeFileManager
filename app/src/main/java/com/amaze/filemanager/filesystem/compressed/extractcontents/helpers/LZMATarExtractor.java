...
public class LZMATarExtractor extends Extractor {

    public LZMATarExtractor(Context context, String filePath, String outputPath, Extractor.OnUpdate listener) {
