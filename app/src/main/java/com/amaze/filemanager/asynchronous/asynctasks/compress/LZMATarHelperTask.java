...
public class LZMATarHelperTask extends CompressedHelperTask {
    private WeakReference<Context> context;
    private String filePath, relativePath;
    public LZMATarHelperTask(Context context, String filePath, String relativePath, boolean goBack,
